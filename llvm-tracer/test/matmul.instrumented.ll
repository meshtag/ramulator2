...
vector.body:                                      ; preds = %vector.body, %vector.ph
  ...
  call void @__mem_trace_store(ptr %4, i64 16)
  ...
  call void @__mem_trace_store(ptr %8, i64 16)
...
.preheader30:                                     ; preds = %19, %middle.block
  %indvars.iv49 = phi i64 [ %indvars.iv.next50, %19 ], [ 0, %middle.block ]
  br label %.preheader

.preheader:                                       ; preds = %18, %.preheader30
  ...
  call void @__mem_trace_load(ptr %10, i64 4)
...
18:                                               ; preds = %11
  call void @__mem_trace_store(ptr %10, i64 4)
