; ModuleID = '/Users/meshtag/LLVMRamulator/ramulator2/llvm-tracer/.test_work/attention_pim/attention_pim.opt.ll'
source_filename = "/Users/meshtag/LLVMRamulator/ramulator2/llvm-tracer/test/attention_pim.c"
...
define i32 @main() local_unnamed_addr #0 {
  call void @__mem_trace_init()
  %1 = alloca [2 x i32], align 8
  %2 = alloca [2 x i32], align 8
  tail call void @pim_init(ptr noundef nonnull @.str) #4
  call void @__mem_trace_store(ptr %1, i64 8)
  store i64 274877907008, ptr %1, align 8
  call void @__mem_trace_store(ptr %2, i64 8)
  store i64 274877907008, ptr %2, align 8
  %3 = call i32 @pim_register_tensor(ptr noundef nonnull @Q, ptr noundef nonnull %1, i32 noundef 2, i32 noundef 4, i32 noundef 1) #4
  %4 = call i32 @pim_register_tensor(ptr noundef nonnull @K, ptr noundef nonnull %1, i32 noundef 2, i32 noundef 4, i32 noundef 0) #4
  %5 = call i32 @pim_register_tensor(ptr noundef nonnull @V, ptr noundef nonnull %1, i32 noundef 2, i32 noundef 4, i32 noundef 0) #4
  %6 = call i32 @pim_register_tensor(ptr noundef nonnull @S, ptr noundef nonnull %2, i32 noundef 2, i32 noundef 4, i32 noundef 2) #4
  %7 = call i32 @pim_register_tensor(ptr noundef nonnull @O, ptr noundef nonnull %1, i32 noundef 2, i32 noundef 4, i32 noundef 2) #4
  br label %vector.ph
...
vector.body:                                      ; preds = %vector.body, %vector.ph
  ...
  call void @__mem_trace_store(ptr %14, i64 16)
  ...
  call void @__mem_trace_store(ptr %20, i64 16)
  ...
  call void @__mem_trace_store(ptr %26, i64 16)
...
28:                                               ; preds = %middle.block
  call void @pim_set_phase(i32 noundef 1) #4
...
.preheader124:                                    ; preds = %129, %.preheader125
...
.preheader123:                                    ; preds = %.preheader123, %.preheader124
  ...
  call void @__mem_trace_load(ptr %78, i64 4)
  ...
  call void @__mem_trace_load(ptr %81, i64 4)
  ...
  call void @__mem_trace_load(ptr %84, i64 4)
  ...
  call void @__mem_trace_load(ptr %87, i64 4)
  ...
  call void @__mem_trace_load(ptr %90, i64 4)
  ...
  call void @__mem_trace_load(ptr %93, i64 4)
  ...
  call void @__mem_trace_load(ptr %96, i64 4)
  ...
  call void @__mem_trace_load(ptr %99, i64 4)
  ...
  call void @__mem_trace_load(ptr %102, i64 4)
  ...
  call void @__mem_trace_load(ptr %105, i64 4)
  ...
  call void @__mem_trace_load(ptr %108, i64 4)
  ...
  call void @__mem_trace_load(ptr %111, i64 4)
  ...
  call void @__mem_trace_load(ptr %114, i64 4)
  ...
  call void @__mem_trace_load(ptr %117, i64 4)
  ...
  call void @__mem_trace_load(ptr %120, i64 4)
  ...
  call void @__mem_trace_load(ptr %123, i64 4)
  ...
  call void @__mem_trace_load(ptr %126, i64 4)
  %127 = load float, ptr %126, align 4
  %128 = fadd float %125, %127
  call void @__mem_trace_store(ptr %126, i64 4)
...
136:                                              ; preds = %134
  call void @pim_set_phase(i32 noundef 2) #4
  br label %137

137:                                              ; preds = %vector.body220, %136
  ...
  call void @__mem_trace_load(ptr %138, i64 4)
...
vector.body229:                                   ; preds = %vector.body229, %vector.ph227
  ...
  call void @__mem_trace_load(ptr %142, i64 8)
  ...
  call void @__mem_trace_store(ptr %142, i64 8)
...
147:                                              ; preds = %147, %137
  ...
  call void @__mem_trace_load(ptr %148, i64 4)
...
.preheader117:                                    ; preds = %middle.block235, %.preheader118
...
vector.body239:                                   ; preds = %vector.body239, %.preheader117
  ...
  call void @__mem_trace_load(ptr %234, i64 16)
  ...
  call void @__mem_trace_load(ptr %236, i64 16)
  ...
  call void @__mem_trace_load(ptr %238, i64 16)
  ...
  call void @__mem_trace_load(ptr %240, i64 16)
  ...
  call void @__mem_trace_load(ptr %242, i64 16)
  ...
  call void @__mem_trace_load(ptr %244, i64 16)
  ...
  call void @__mem_trace_load(ptr %246, i64 16)
  ...
  call void @__mem_trace_load(ptr %248, i64 16)
  ...
  call void @__mem_trace_load(ptr %250, i64 16)
  ...
  call void @__mem_trace_load(ptr %252, i64 16)
  ...
  call void @__mem_trace_load(ptr %254, i64 16)
  ...
  call void @__mem_trace_load(ptr %256, i64 16)
  ...
  call void @__mem_trace_load(ptr %258, i64 16)
  ...
  call void @__mem_trace_load(ptr %260, i64 16)
  ...
  call void @__mem_trace_load(ptr %262, i64 16)
  ...
  call void @__mem_trace_load(ptr %264, i64 16)
  ...
  call void @__mem_trace_load(ptr %266, i64 16)
  %wide.load289 = load <4 x float>, ptr %266, align 4
  %267 = fadd <4 x float> %265, %wide.load289
  call void @__mem_trace_store(ptr %266, i64 16)
...
275:                                              ; preds = %273
  call void @pim_set_phase(i32 noundef 0) #4
  call void @pim_finalize() #4
  call void @__mem_trace_fini()
  ret i32 0
}
...
declare void @__mem_trace_load(ptr, i64)

declare void @__mem_trace_store(ptr, i64)

declare void @__mem_trace_init()

declare void @__mem_trace_fini()
