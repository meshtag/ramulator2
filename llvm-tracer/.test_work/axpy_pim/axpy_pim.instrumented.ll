; ModuleID = '/Users/meshtag/LLVMRamulator/ramulator2/llvm-tracer/.test_work/axpy_pim/axpy_pim.opt.ll'
...
vector.ph:
  ...
  call void @__mem_trace_store(ptr %0, i64 4)
...
vector.body:                                      ; preds = %vector.body, %vector.ph
  ...
  call void @__mem_trace_store(ptr %6, i64 16)
  ...
  call void @__mem_trace_store(ptr %10, i64 16)
...
vector.body25:                                    ; preds = %vector.body25, %middle.block
  ...
  call void @__mem_trace_store(ptr %16, i64 16)
  store <4 x float> %20, ptr %16, align 4
  call void @__mem_trace_store(ptr %17, i64 16)
  store <4 x float> %21, ptr %17, align 4
  call void @__mem_trace_store(ptr %18, i64 16)
  store <4 x float> %22, ptr %18, align 4
  call void @__mem_trace_store(ptr %19, i64 16)
